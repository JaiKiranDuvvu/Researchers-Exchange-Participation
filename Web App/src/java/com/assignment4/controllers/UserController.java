    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("")) {
                        ...
                        if (checkUserExists == null) {
                            ...
                            if (tempUser == null) {
                                ...
                                if (null != activationToken && !("").equalsIgnoreCase(activationToken)) {
                                    ...
                                    String Message = request.getRequestURL() + CommonUtility.ACTIVATION_LINK + activationToken + "&email=" + toEmail;
            ...
            if (null != user) {
                ...
                String actionLink = request.getRequestURL() + CommonUtility.RESET_LINK + cryptTime;
                ...
                if (status) {
                    int count=udao.insertForgotPasswordRecord(toEmail,cryptTime);
                    if(count==1){
            ...
            try {
                userDAO udao = new userDAOImpl();
                int count=udao.getForgotPasswordRecord(email,cryptText);
                if(count==1){
